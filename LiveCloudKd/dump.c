...
)
{
    ...
    {
		if (Index % (10 * BLOCK_SIZE)) printf("%I64d MBs... ", Index / BLOCK_SIZE);
...
)
{
	...
	FunctionTable._SdkHvmmReadVmMemory = SdkHvmmReadVmMemory;
	...
	FunctionTable.ReadMemoryMethod = g_MemoryInterfaceType;
